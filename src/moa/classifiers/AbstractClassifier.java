...
public abstract class AbstractClassifier extends AbstractOptionHandler implements Classifier {
    ...
    public FlagOption randomClassifierOption = new FlagOption("random", 'r', "");
    
    /** Option for randomizable learners to change the random seed */
    public IntOption randomSeedOption = new IntOption("randomSeed", 's', "Seed for random behaviour of the classifier.", 1);
    ...
    public boolean isRandomizable() {
    	return this.randomClassifierOption.isSet();
    }
    
    /**
     * Sets whether this classifier needs a random seed.
     * Examples of methods that needs a random seed are bagging and boosting.
     *
     * @param randomizable true if the classifier needs a random seed.
     */
    public void setRandomizable(boolean randomizable) {
    	this.randomClassifierOption.setValue(randomizable);
    }
    ...
    public int getRandomSeed() {
    	this.randomSeed = this.randomSeedOption.getValue();
    	return this.randomSeedOption.getValue();
    }
}
